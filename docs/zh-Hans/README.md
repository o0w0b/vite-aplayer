...
fixed | false | 开启吸底模式, [详情](https://aplayer.o0w0b.top/#/home?id=fixed-mode)
mini | false | 开启迷你模式, [详情](https://aplayer.o0w0b.top/#/home?id=mini-mode)
...
audio.url | - | 音频链接
audio.cover | - | 音频封面
audio.lrc | - | [详情](https://aplayer.o0w0b.top/#/home?id=lrc)
audio.theme | - | 切换到此音频时的主题色，比上面的 theme 优先级高
audio.type | 'auto' | 可选值: 'auto', 'hls', 'normal' 或其他自定义类型, [详情](https://aplayer.o0w0b.top/#/home?id=mse-support)
customAudioType | - | 自定义类型，[详情](https://aplayer.o0w0b.top/#/home?id=mse-support)
mutex | true | 互斥，阻止多个播放器同时播放，当前播放器播放时暂停其他播放器
lrcType | 0 | [详情](https://aplayer.o0w0b.top/#/home?id=lrc)
...
+ `ap.on(event: string, handler: function)`: 绑定音频和播放器事件，[详情](https://aplayer.o0w0b.top/#/home?id=event-binding)
...
需要在 `APlayer.umd.js` 前面加载 [hls.js](https://github.com/video-dev/hls.js)。
