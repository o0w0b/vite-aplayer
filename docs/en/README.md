...
🍭 APlayer, with both ESM and UMD builds.
...
```
npm install vite-aplayer
```

Using Yarn:

```
yarn add vite-aplayer
```
...
<div id="aplayer"></div>
<script src="APlayer.umd.js"></script>
```
...
```js
import 'vite-aplayer/dist/APlayer.min.css';
import APlayer from 'vite-aplayer';
...
fixed | false | enable fixed mode, [see more details](https://aplayer.o0w0b.top/#/home?id=fixed-mode)
mini | false | enable mini mode, [see more details](https://aplayer.o0w0b.top/#/home?id=mini-mode)
...
audio.lrc | - | [see more details](https://aplayer.o0w0b.top/#/home?id=lrc)
audio.theme | - | main color when switching to this audio, it has priority over the above theme
audio.type | 'auto' | values: 'auto', 'hls', 'normal' or other custom type, [see more details](https://aplayer.o0w0b.top/#/home?id=mse-support)
customAudioType | - | [see more details](https://aplayer.o0w0b.top/#/home?id=mse-support)
mutex | true | prevent to play multiple player at the same time, pause other players when this player start play
lrcType | 0 | [see more details](https://aplayer.o0w0b.top/#/home?id=lrc)
...
+ `ap.on(event: string, handler: function)`: bind audio and player events, [see more details](https://aplayer.o0w0b.top/#/home?id=event-binding)
...
It requires the library [hls.js](https://github.com/video-dev/hls.js) and it should be loaded before `APlayer.umd.js`.
...
- [jsDelivr](https://www.jsdelivr.com/package/npm/vite-aplayer)
<!-- - [cdnjs](https://cdnjs.com/libraries/vite-aplayer) -->
<!-- - [unpkg](https://unpkg.com/vite-aplayer/) -->
